...
import { v as hash, x as klona, y as defuFn } from '../runtime.mjs';
...
const useStateStore = defineStore("state", () => {
  ...
  const indexPost = async ({ tags: tags2 = "", index = 1, size = 10 } = {}) => {
    ...
    posts.value = (_a2 = (_a = data == null ? void 0 : data.data) == null ? void 0 : _a.items) != null ? _a2 : [];
...
//# sourceMappingURL=state-CD0KKUP6.mjs.map
