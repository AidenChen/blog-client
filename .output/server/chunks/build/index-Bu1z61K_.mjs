...
import { u as useStateStore, m as marked$1 } from './state-BOqYbhzT.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "post-list" }, _attrs))} data-v-03a69a94>`);
      if (unref(posts).length !== 0) {
        _push(`<ul class="post-items" data-v-03a69a94><!--[-->`);
        ssrRenderList(unref(posts), (post, index2) => {
          var _a;
          _push(`<li class="post-item" data-v-03a69a94><p class="post-time" data-v-03a69a94>${ssrInterpolate(post.created_at)}</p><h1 class="post-title" data-v-03a69a94>`);
          ...
          _push(`</h1><div class="post-abstract markdown-body" data-v-03a69a94>${(_a = compiledMarkdown(post.abstract)) != null ? _a : ""}</div><p data-v-03a69a94>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/posts/" + post.id,
            class: "post-entry"
          }, {
          ...
          _push(`</p><p data-v-03a69a94><!--[-->`);
          ssrRenderList(post.tags, (tag, index22) => {
            _push(`<span class="post-tag" data-v-03a69a94>${ssrInterpolate(tag.name)}</span>`);
          });
          _push(`<!--]--></p></li>`);
        });
        _push(`<!--]--></ul>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-03a69a94"]]);

export { index as default };
//# sourceMappingURL=index-Bu1z61K_.mjs.map
