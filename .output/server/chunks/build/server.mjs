...
const customRoutes = [
  ...
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./index-BXZGaW71.mjs').then((r) => r.default || r)
  },
  {
    path: "/posts",
    ...
    children: [
      {
        name: "post-list",
        path: "",
        component: () => import('./index-n9QNfFag.mjs').then((r) => r.default || r)
      },
      {
        name: "post-detail",
        path: ":id",
        component: () => import('./index-xs5jRqaQ.mjs').then((r) => r.default || r)
      }
    ]
  },
  {
    name: "tag",
    path: "/tags",
    component: () => import('./index-CQDUL1OP.mjs').then((r) => r.default || r)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./index-bgBycBVR.mjs').then((r) => r.default || r)
  }
];
...
const layouts = {
  ...
  "top-bar": () => import('./top-bar-vZ1RT7ES.mjs').then((m) => m.default || m)
};
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, __nuxt_component_0 as c, useRoute as d, entry$1 as default, cfg0 as e, useNuxtApp as f, asyncDataDefaults as g, createError as h, injectHead as i, fetchDefaults as j, defineStore as k, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, storeToRefs as s, useRouter as u };
