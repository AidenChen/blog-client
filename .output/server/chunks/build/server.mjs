...
const customRoutes = [
  ...
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./index-DvECTCY7.mjs').then((r) => r.default || r)
  },
  {
    path: "/posts",
    ...
    children: [
      {
        name: "post-list",
        path: "",
        component: () => import('./index-DCTpX-mv.mjs').then((r) => r.default || r)
      },
      {
        name: "post-detail",
        path: ":id",
        component: () => import('./index-MuBFQ5V-.mjs').then((r) => r.default || r)
      }
    ]
  },
  {
    name: "tag",
    path: "/tags",
    component: () => import('./index-Bvu87sDR.mjs').then((r) => r.default || r)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./index-eekDfuPY.mjs').then((r) => r.default || r)
  }
];
...
const layouts = {
  ...
  "top-bar": () => import('./top-bar-DKPRgt-0.mjs').then((m) => m.default || m)
};
