...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "top-bar" }, _attrs))} data-v-fcf82ca7><div class="top-bar-inner" data-v-fcf82ca7><nav class="site-nav" data-v-fcf82ca7><img class="top__menu"${ssrRenderAttr("src", _imports_0)} alt="\u83DC\u5355" data-v-fcf82ca7><div class="trigger" data-v-fcf82ca7>`);
...
const topBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fcf82ca7"]]);

export { topBar as default };
//# sourceMappingURL=top-bar-XzBBtjVj.mjs.map
