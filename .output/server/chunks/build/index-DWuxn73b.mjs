...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tag" }, _attrs))} data-v-f9342dc7><ul class="tag-items" data-v-f9342dc7><!--[-->`);
      ssrRenderList(unref(tags), (tag, index2) => {
        _push(`<li class="tag-item" data-v-f9342dc7><span data-v-f9342dc7>${ssrInterpolate(tag.name)}</span></li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f9342dc7"]]);

export { index as default };
//# sourceMappingURL=index-DWuxn73b.mjs.map
