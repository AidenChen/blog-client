...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "top-bar" }, _attrs))} data-v-b456ed5e><div class="top-bar-inner" data-v-b456ed5e><nav class="top-bar-nav" data-v-b456ed5e><img class="top-bar-menu"${ssrRenderAttr("src", _imports_0)} alt="\u83DC\u5355" data-v-b456ed5e><div class="${ssrRenderClass([{ hover: unref(isHover) }, "trigger"])}" data-v-b456ed5e>`);
...
const topBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b456ed5e"]]);

export { topBar as default };
//# sourceMappingURL=top-bar-vZ1RT7ES.mjs.map
