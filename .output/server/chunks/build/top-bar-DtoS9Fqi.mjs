...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "top-bar" }, _attrs))} data-v-171b8ae5><div class="top-bar-inner" data-v-171b8ae5><nav class="site-nav" data-v-171b8ae5><img class="top__menu"${ssrRenderAttr("src", _imports_0)} alt="\u83DC\u5355" data-v-171b8ae5><div class="${ssrRenderClass([{ hover: unref(isHover) }, "trigger"])}" data-v-171b8ae5>`);
...
const topBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-171b8ae5"]]);

export { topBar as default };
//# sourceMappingURL=top-bar-DtoS9Fqi.mjs.map
