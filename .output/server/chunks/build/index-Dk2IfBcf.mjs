...
import { u as useStateStore, m as marked$1 } from './state-nnoB2YQ_.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "post-list" }, _attrs))} data-v-08dace74><ul class="post-items" data-v-08dace74><!--[-->`);
      ssrRenderList(unref(posts), (post) => {
        var _a;
        _push(`<li class="post-item" data-v-08dace74><p class="post-time" data-v-08dace74>${ssrInterpolate(post.created_at)}</p><h1 class="post-title" data-v-08dace74>`);
        ...
        _push(`</h1>`);
        if (post.abstract) {
          _push(`<div class="post-abstract markdown-body" data-v-08dace74>${(_a = compiledMarkdown(post.abstract)) != null ? _a : ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (post.abstract) {
          _push(`<p data-v-08dace74>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/posts/" + post.id,
            class: "post-entry"
          }, {
        ...
        if (post.tags.length) {
          _push(`<p style="${ssrRenderStyle({ "margin-top": "0" })}" data-v-08dace74><!--[-->`);
          ssrRenderList(post.tags.sort((a, b) => a.name.localeCompare(b.name)), (tag) => {
            _push(`<span class="post-tag" data-v-08dace74>${ssrInterpolate(tag.name)}</span>`);
          });
          _push(`<!--]--></p>`);
        } else {
          _push(`<!---->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08dace74"]]);

export { index as default };
//# sourceMappingURL=index-Dk2IfBcf.mjs.map
