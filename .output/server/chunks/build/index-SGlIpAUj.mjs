...
import { u as useStateStore } from './state-CD0KKUP6.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(posts).length !== 0) {
        ...
        ssrRenderList(unref(posts), (post, index2) => {
          ...
          _push(`</h1><div class="post-abstract markdown-body" data-v-6acb5a1b>${(_a = compiledMarkdown(post.abstract)) != null ? _a : ""}</div><p data-v-6acb5a1b>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/posts/" + post.id,
            class: "post-entry"
          }, {
...
//# sourceMappingURL=index-SGlIpAUj.mjs.map
