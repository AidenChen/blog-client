import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, isRef, isReactive, watch, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const customRoutes = [
  ...
  },
  {
    name: "home",
    path: "/home",
    component: () => import("./_nuxt/index-BXZGaW71.js").then((r) => r.default || r)
  },
  {
    path: "/posts",
    ...
    children: [
      {
        name: "post-list",
        path: "",
        component: () => import("./_nuxt/index-n9QNfFag.js").then((r) => r.default || r)
      },
      {
        name: "post-detail",
        path: ":id",
        component: () => import("./_nuxt/index-xs5jRqaQ.js").then((r) => r.default || r)
      }
    ]
  },
  {
    name: "tag",
    path: "/tags",
    component: () => import("./_nuxt/index-CQDUL1OP.js").then((r) => r.default || r)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/index-bgBycBVR.js").then((r) => r.default || r)
  }
];
...
const layouts = {
  ...
  "top-bar": () => import("./_nuxt/top-bar-vZ1RT7ES.js").then((m) => m.default || m)
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))} data-v-d663c27c>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d663c27c"]]);
const _sfc_main$1 = {
