    ...
    children: [
      {
        name: "post-list",
        path: "",
        component: () => import("./_nuxt/index-DPWTDKJK.js").then((r) => r.default || r)
      },
      {
        name: "post-detail",
        path: ":id",
        component: () => import("./_nuxt/index-rpguSDaX.js").then((r) => r.default || r)
      }
    ]
  },
  {
    name: "tag",
    path: "/tags",
    component: () => import("./_nuxt/index-CCLtLrKA.js").then((r) => r.default || r)
  },
  {
    name: "profile",
    path: "/profile",
...
const layouts = {
  ...
  "top-bar": () => import("./_nuxt/top-bar-DCJgc3ID.js").then((m) => m.default || m)
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))} data-v-bbdc5fcd>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bbdc5fcd"]]);
const _sfc_main$1 = {
